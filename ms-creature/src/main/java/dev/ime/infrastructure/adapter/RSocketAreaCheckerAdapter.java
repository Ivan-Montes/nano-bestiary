...
@Component
@Qualifier("rSocketAreaCheckerAdapter")
public class RSocketAreaCheckerAdapter implements EntityCheckerPort{
    ...
    public RSocketAreaCheckerAdapter(ReactiveLoggerUtils reactiveLoggerUtils, Builder rsocketRequesterBuilder,
	...
	private Mono<Map<String, String>> createConnectionInfo(UUID id){
		...
		return Mono.fromCallable(()->{
			...
			InstanceInfo instanceInfo = eurekaClient.getNextServerFromEureka(GlobalConstants.MS_AREA, false);
	...
	private Mono<Boolean> consultExternalMicroserviceWithRSocket(Map<String, String> map) {
		...
		return rsocketRequesterBuilder
		        ...
		        .route("areas.existsById." + map.get(GlobalConstants.AREA_ID))
