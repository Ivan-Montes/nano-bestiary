...
public class KafkaCreatureSubscriberAdapter implements SubscriberPort{
	...
	public KafkaCreatureSubscriberAdapter(ReactiveLoggerUtils reactiveLoggerUtils, @Qualifier("creatureProjectorAdapter")BaseProjectorPort baseProjectorPort, @Qualifier("creatureProjectorAdapter")ExtendedProjectorPort extendedProjectorPort) {
		super();
	...
	private Map<String, Function<Event, Mono<?>>> initializeActionsMap() {
		...
		return Map.of(
                ...
                GlobalConstants.CREATURE_UPDATED, extendedProjectorPort::update,
                GlobalConstants.CREATURE_DELETED, baseProjectorPort::deleteById
        );
		
	}

	@KafkaListener(topics = {GlobalConstants.CREATURE_CREATED, GlobalConstants.CREATURE_UPDATED, GlobalConstants.CREATURE_DELETED}, groupId = "mscreature-consumer-creature")
	@Override
