...
class RSocketCreatureCheckerAdapterTest {
	...
	@InjectMocks
	private RSocketCreatureCheckerAdapter rSocketCreatureCheckerAdapter;
	...
	void existsAnyByAreaId_shouldReturnTrue() {
		...
		StepVerifier
		.create(rSocketCreatureCheckerAdapter.existsAnyByAreaId(areaId01))
		.expectNext(true)
        .verifyComplete();
