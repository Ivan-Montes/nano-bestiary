...
class KafkaCreatureSubscriberAdapterTest {
	...
	@InjectMocks
	private KafkaCreatureSubscriberAdapter kafkaCreatureSubscriberAdapter;	
	...
	void onMessage_shouldProcessMessage() {
		...
		StepVerifier
		.create(kafkaCreatureSubscriberAdapter.onMessage(consumerRecord))
		.verifyComplete();
