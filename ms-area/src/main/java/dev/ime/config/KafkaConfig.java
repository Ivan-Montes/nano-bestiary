...
public class KafkaConfig {
	...
	KafkaAdmin.NewTopics topics() {
		...
		return new NewTopics(
				TopicBuilder.name(GlobalConstants.AREA_CREATED).build(),
				TopicBuilder.name(GlobalConstants.AREA_UPDATED).build(),
				TopicBuilder.name(GlobalConstants.AREA_DELETED).build()
				);
